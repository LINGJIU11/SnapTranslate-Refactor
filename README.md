...
python -m unittest discover -s tests -t .     # 单元测试（158 项）
...
python scripts\gui_smoke.py --with-tk         # 真实创建三个 Tk 窗口后立即销毁
